...
class UntitledTestCase3(unittest.TestCase):
    ...
    def gogoreg(self):
        ...
        left = 1#element.location['x']
        top = 5#element.location['y']
        right =23# element.location['x'] + element.size['width']
        bottom =90# element.location['y'] + element.size['height']
